...
},{"../../html5-common/js/utils/InitModules/InitOO.js":1,"../../html5-common/js/utils/InitModules/InitOOUnderscore.js":2}],4:[function(require,module,exports){
      ...
      case OO.Analytics.EVENTS.VIDEO_SOURCE_CHANGED:
        if (params && params[0] && params[0].embedCode)
        {
          if (currentEmbedCode && params[0].embedCode !== currentEmbedCode) {
            this.updateMetadata(params[0].metadata["omniture"]);
          }
